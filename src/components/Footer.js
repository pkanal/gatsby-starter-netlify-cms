...
export const Footer = () => (
  <footer class="ph3 ph4-ns pt5 pb3 bt b--black-10 black-70">
    <a
      ...
      class="link b f3 f2-ns lh-solid blue hover-light-blue libre-baskerville i"
    >
      hello@bridgeschool.io
    </a>
    <div class="mt5 mb3">
      <a href="/" title="home" class="f6 dib pr2 blue hover-pink no-underline">
        Home
      </a>
      <a
        href="/apply-dev"
        title="apply-dev"
        class="f6 dib ph2 blue hover-pink no-underline"
      >
    ...
    <div class="pv3">
      <a
        id="facebook-footer"
        target="_blank"
        class="link blue hover-light-blue dib h2 w2 mr3"
        href="https://www.facebook.com/itsbridgeschool/"
        title="Facebook"
      >
        <svg
          fill="currentColor"
      ...
      <a
        ...
        target="_blank"
        class="link blue hover-light-blue dib h2 w2 mr3"
        href="https://www.instagram.com/itsbridgeschool/"
        title="Instagram"
      >
        <svg
          fill="currentColor"
      ...
      <a
        ...
        target="_blank"
        class="link blue hover-light-blue dib h2 w2 mr3"
        href="https://www.linkedin.com/company/25031544/"
        title="LinkedIn"
      >
        <svg
          fill="currentColor"
      ...
      <a
        ...
        target="_blank"
        class="link blue hover-light-blue dib h2 w2 mr3"
        href="https://twitter.com/itsbridgeschool"
        title="Twitter"
      >
        <svg
          fill="currentColor"
      ...
      <a
        ...
        target="_blank"
        class="link blue hover-light-blue dib h2 w2 mr3"
        href="https://medium.com/@itsbridgeschool"
        title="Medium"
      >
        <svg
          fill="currentColor"
